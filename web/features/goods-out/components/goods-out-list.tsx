      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            <RefreshButton queryKeys={[['goods-out']]} resource="goods out receipts" />
            <ExportButton
              fetchData={async () => results}
              filename="goods-out"
              resource="goods out receipts"
            />
          </div>
        </div>
        ...
        {!hasData ? (
          <EmptyState
            ...
            description={query ? "Try adjusting your search criteria." : "There are no goods out receipts to display."}
